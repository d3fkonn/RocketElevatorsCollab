...
let headerSelectColor= document.getElementById("buildingSelectHeader")
let headerInfoColor = document.getElementById("buildingInfoHeader")
let headerProductColor = document.getElementById("productLineHeader")
let headerPricingColor = document.getElementById("pricingHeader")
buildingType_select.addEventListener("change", () => {
    if (buildingType === 'residential'){
        headerSelectColor.style.backgroundColor = 'blue'
    headerInfoColor.style.backgroundColor = 'blue'
    headerProductColor.style.backgroundColor ='blue'
    headerPricingColor.style.backgroundColor ='blue'
    }
    else if (buildingType=== 'commercial'){
        headerSelectColor.style.backgroundColor = 'red'
        headerInfoColor.style.backgroundColor = 'red'
    headerProductColor.style.backgroundColor ='red'
    headerPricingColor.style.backgroundColor ='red'
    }
    else if (buildingType === 'industrial'){
        headerSelectColor.style.backgroundColor = 'grey'
        headerInfoColor.style.backgroundColor = 'grey'
    headerProductColor.style.backgroundColor ='grey'
    headerPricingColor.style.backgroundColor ='grey'
    }
